                                ...
                                <h4 class="card-title">Total Duration</h4>
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" id="duration" name="duration">
                                            ...
                                            <option value="12">Two Years</option>
                                            <option value="13">Three Years</option>
                                        </select>
                                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra UGX 300,000 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
